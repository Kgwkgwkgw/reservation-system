...
<script>
    require(["myreservation", "myreservationModel"], function(MyReservationPresenter, MyReservationModel) {
        "use strict";
        ...
        MyReservationPresenter.init(myReservationModel, objReservationType);
    });
</script>
</html>
